...
public static class ServiceExtensions
{
    ...
    public static void ConfigureSqlContext(
        ...
        services.AddDbContext<RepositoryContext>(options =>
            options.UseMySql(
                connectionString: configuration["MariaDB:ConnectionString"],
                serverVersion: new MariaDbServerVersion(configuration["MariaDB:ServerVersion"])
            )
        );
    ...
    public static void AddCustomMediaTypes(this IServiceCollection services)
    {
        services.Configure<MvcOptions>(config =>
        {
            ...
            {
                systemTextJsonOutputFormatter.SupportedMediaTypes.Add(
            ...
            var xmlOutputFormatter = config
                .OutputFormatters.OfType<XmlDataContractSerializerOutputFormatter>()
                ?.FirstOrDefault();
